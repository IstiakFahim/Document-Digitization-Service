...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUnlockButton = findViewById(R.id.unlockButton);
        ...
        mUnlockButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent publicfiles = new Intent(getApplicationContext(), MyPublicFile.class);
                startActivity(publicfiles);
            }
        });
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("uploads").child("private").orderByChild("uid").equalTo(user.getUid());
                        ...
                        new AlertDialog.Builder(MainActivity.this)
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Toast.makeText(getApplicationContext(), mpostKey + "deleted", Toast.LENGTH_LONG).show();
                                        ...
                                        applesQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                Intent newclass = new Intent(MainActivity.this, MainActivity.class);
